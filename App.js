...
export default function App() {
  ...
  useCode(
    ...
    cond(eq(gestureState.current, State.END), [
        ...
        cond(eq(isOpen.current, 1), delay(call([], focusTextImput), 750)), // acho que e o tempo da subida do teclado 
      ]),          
      ...
      >
        ...
        <Animated.View>
          ...
          >
            ...
            >
              <Text style={{ fontSize: 24 }}>Digite o telefone</Text>
            </Animated.View>
